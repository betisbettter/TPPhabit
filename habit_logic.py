...
habit_list = [
    ...
    "Read or listen to something that inspires you for 10 min",
    ...
    "Forgive someone today or forgive youself",
    ...
    "Create a 3-line affirmation to speak into exisistance",
    "Celebrate your consistency",
    "Pick 2 habits from each week to carry on for this week",
    "Train without music or distraction today",
    "Teach someone else 1 thing that you have learned from this challenge",
    "Revisit your 'Why'",
